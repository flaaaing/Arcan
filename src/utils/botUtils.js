...
async function checkForUpdates() {
  const response = await getResponse("https://api.github.com/repos/flaaaing/Arcan/releases/latest");
  ...
  if (response.data) {
    if (require("@root/package.json").version.replace(/[^0-9]/g, "") >= response.data.tag_name.replace(/[^0-9]/g, "")) {
      ...
      console.log("\x1b[32m[Download]:\x1b[0m https://github.com/flaaaing/Arcan/releases/latest");
    }
  }
}
